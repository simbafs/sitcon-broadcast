...
type Event struct {
	...
	// js script to process session.json to ent.Session
...
func (*Event) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case event.FieldName, event.FieldURL, event.FieldScript:
