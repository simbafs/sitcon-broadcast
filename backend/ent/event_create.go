...
func (ec *EventCreate) SetScript(s string) *EventCreate {
	ec.mutation.SetScript(s)
	return ec
}
...
func (ec *EventCreate) check() error {
	...
	if _, ok := ec.mutation.Script(); !ok {
		return &ValidationError{Name: "script", err: errors.New(`ent: missing required field "Event.script"`)}
	}
	return nil
}
...
func (ec *EventCreate) createSpec() (*Event, *sqlgraph.CreateSpec) {
	...
	if value, ok := ec.mutation.Script(); ok {
