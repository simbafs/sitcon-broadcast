...
func (eu *EventUpdate) SetScript(s string) *EventUpdate {
	eu.mutation.SetScript(s)
	return eu
}

// SetNillableScript sets the "script" field if the given value is not nil.
func (eu *EventUpdate) SetNillableScript(s *string) *EventUpdate {
	if s != nil {
		eu.SetScript(*s)
	}
	return eu
...
func (eu *EventUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := eu.mutation.Script(); ok {
		_spec.SetField(event.FieldScript, field.TypeString, value)
	}
...
// SetScript sets the "script" field.
func (euo *EventUpdateOne) SetScript(s string) *EventUpdateOne {
	euo.mutation.SetScript(s)
	return euo
}

// SetNillableScript sets the "script" field if the given value is not nil.
func (euo *EventUpdateOne) SetNillableScript(s *string) *EventUpdateOne {
	if s != nil {
		euo.SetScript(*s)
	}
	return euo
...
func (euo *EventUpdateOne) sqlSave(ctx context.Context) (_node *Event, err error) {
	...
	if value, ok := euo.mutation.Script(); ok {
		_spec.SetField(event.FieldScript, field.TypeString, value)
	}
